 ...
 */
public class HW4Output1_1 {
    /**Step 1: Be sure to put the "files"(ONLY THE FILES DIRECTORY) directory into the cwd of your FTP server.
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        System.out.printf("GET files/comp431/!.txt%s",EOL);
            System.out.printf("GET accepted for files/comp431/!.txt%s",EOL);
        System.out.printf("PORT %s,%s%s",ip,convertPort(port),CRLF);
            System.out.printf("FTP reply 200 accepted. Text is : Port command successful (%s,%d).%s",ip_dot,port++,EOL);
        ...
        System.out.printf("GET files/one_does_not_simply_get_this_file.txt%s",EOL);
            System.out.printf("GET accepted for files/one_does_not_simply_get_this_file.txt%s",EOL);
        System.out.printf("PORT %s,%s%s",ip,convertPort(port),CRLF);
            System.out.printf("FTP reply 200 accepted. Text is : Port command successful (%s,%d).%s",ip_dot,port++,EOL);
        System.out.printf("RETR files/one_does_not_simply_get_this_file.txt%s",CRLF);
            System.out.printf("FTP reply 550 accepted. Text is : File not found or access denied.%s",EOL);
